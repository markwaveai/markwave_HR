...
const EmployeeOverviewCard = ({ stats, onShowAbsentees }) => {
    ...
    return (
        <View style={styles.card}>
            <View style={styles.cardHeader}>
                ...
                <Icon name="users" size={20} color="#636e72" />
            </View>
            ...
            <View style={styles.statsRow}>
                ...
                <View style={{ flex: 1, alignItems: 'flex-end', justifyContent: 'center' }}>
                    ...
                    >
                        <Icon name="arrow-right" size={24} color="#48327d" />
                    </TouchableOpacity>
                </View>
            </View>
        </View>
