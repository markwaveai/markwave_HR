...
import { getGeolocation, showAlert } from '../utils/platform';
...
const MeScreen = ({ user }) => {
    ...
    const [activeBreakLog, setActiveBreakLog] = useState(null);
    ...
    const fetchData = async () => {
        try {
            ...
            // Set today  day in timing card
            const todayStr = toLocalDateString(new Date());
            const todayIdxInHistory = history.findIndex((l) => l.date === todayStr);
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                <View style={[styles.card, { marginBottom: 16 }]}>
                    <View style={styles.cardHeaderFlex}>
                        ...
                        <Icon name="info" size={13} color="#b2bec3" />
                    </View>
                    ...
                    <View style={styles.statsRow}>
                        <View style={styles.statsRowIdentity}>
                            <View style={styles.statsIconCircle}>
                                <Icon name="user" size={15} color="#48327d" style={{ opacity: 0.8 }} />
                            </View>
                    ...
                    <View style={[styles.statsRow, { marginTop: 16, borderTopWidth: 1, borderTopColor: '#f1f5f9', paddingTop: 16 }]}>
                        <View style={styles.statsRowIdentity}>
                            <View style={[styles.statsIconCircle, { backgroundColor: '#fcfaff' }]}>
                                <Icon name="users" size={14} color="#48327d" />
                            </View>
                        ...
                        <View style={styles.progressSection}>
                            ...
                            <View style={styles.timingFooterRow}>
                                ...
                                <View style={styles.timingFooterBreak}>
                                    <Icon name="coffee" size={13} color="#636e72" style={{ marginRight: 4 }} />
                ...
                <View style={[styles.card, { marginBottom: 24 }]}>
                    ...
                    <View style={styles.actionGrid}>
                        ...
                        <View style={styles.actionLinksSide}>
                            ...
                            >
                                <View style={styles.actionLinkIcon}>
                                    {!canClock && disabledReason === 'On Leave' ? <Icon name="sun" size={18} color="#48327d" /> :
                                        !canClock && disabledReason === 'Holiday' ? <Icon name="gift" size={18} color="#48327d" /> :
                                            clockStatus === 'IN' ? <Icon name="log-out" size={18} color="#48327d" /> : <Icon name="log-in" size={18} color="#48327d" />}
                                </View>
                            ...
                            <TouchableOpacity style={styles.actionLinkItem}>
                                <Icon name="home" size={18} color="#48327d" style={styles.actionLinkIcon} />
